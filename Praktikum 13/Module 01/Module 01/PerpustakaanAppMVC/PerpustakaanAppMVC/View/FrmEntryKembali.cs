...
{
    public partial class FrmEntryKembali : Form
    {
        ...
        public FrmEntryKembali(string title, TransaksiController controller)
            : this()
        {
        ...
        public FrmEntryKembali(string title, Transaksi obj, TransaksiController controller)
            : this()
        {
            // ganti text/judul form
            this.Text = title;
            ...
            dtmKembali.Text = transaksi.Tglk;
        ...
        private void btnSimpan_Click(object sender, EventArgs e)
        {
            ...
            transaksi.Tglk = dtmKembali.Text;
